            ...
            .then(data => {
                ...
                data.forEach(element => {
                    if (!category || element.cate_id === getCategoryID(category)) {
                        ...
                        <a href="single-product.html?id=${element.id}">
                            <div class="featured-item">
                                <a href="single-product.html?id=${element.id}"><img src="${element.image}" alt="Image" class="img-fluid" width="200px" height="50px">
                                    <h4>${element.name}</h4>
                                    <h6>${element.price}$</h6>
